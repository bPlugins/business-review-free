...
const welcomeInfo = adminUrl => ({
  ...
  changelogs: [{
    ...
    type: 'new',
    list: ['Enhancement: If an API call fails, a user-friendly error message will be displayed.', 'Fix: The Yelp API issue has been resolved; the reason it was failing was that it could not fetch the reviews.', 'Update:A modern dashboard has been added to both the Pro and Free versions of the Business Reviews plugin.']
  }, {
