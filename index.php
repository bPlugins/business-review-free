...
if (function_exists('grbb_fs')) {
    ...
    class GRBB_Business_Review {
        ...
        public function load_classes() {
            require_once plugin_dir_path(__FILE__) . '/vendor/includes/api/BusinessReviewAPI.php';
            require_once plugin_dir_path(__FILE__) . '/vendor/includes/custom-post.php';
            new GRBBB_CPT\Business_Review_Custom_Post_Type();
            require_once plugin_dir_path(__FILE__) . '/vendor/includes/admin-menu.php';
        }
